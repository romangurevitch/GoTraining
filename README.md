...
- [The Basics & The Mental Shift](internal/basics/README.md#the-mental-shift)
...
- [Defining Data & Structure](internal/basics/README.md#structs--layout)
...
- [Abstraction & Polymorphism](internal/basics/README.md#behaviours)
    - [Interfaces](internal/basics/interface/README.md)
    - [Type Assertions & Casting](internal/basics/casting/README.md)
- [Testing & Performance](internal/basics/README.md#testing--benchmarking)
